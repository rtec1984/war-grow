...
@section('content')
<div class="col-md-6" style="text-align: justify; padding: 2rem; margin-bottom: 7rem;">
    ...
    <p>Colocar o nome seguido do apelido entre parênteses e retirar o nome da lista se não for jogar. As listas terão
        ...
        tempo de espera é de no máximo 5 minutos à partir da criação da mesa e chamada dos integrantes da lista no grupo,
    ...
    <p>As partidas valem 10 pontos, tem duração de até 90 minutos e podem ser jogadas quantas vezes quiser, uma de cada
        vez com 3, 4, 5 ou 6 jogadores. Para que as partidas sejam válidas para o ranking é necessário que uma lista com o
