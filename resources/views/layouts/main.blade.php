  ...
  <footer>
    ...
    <div class="container">
        <div class="row">
          ...
          <div class="col-sm">
            <a href="https://www.instagram.com/war_grow/" target="_blank"><ion-icon name="logo-instagram"></ion-icon></a>
          </div>
            <div class="col-sm">
            <a href="https://discord.com/invite/7cNqtMQpnt" target="_blank"><ion-icon name="logo-discord"></ion-icon></a>
          </div>
          <div class="col-sm">
