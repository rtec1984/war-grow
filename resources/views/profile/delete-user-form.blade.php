<x-jet-action-section>
    ...
    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600">
            ...
            Antes de excluir sua conta, faça o download de quaisquer dados ou informações que deseja reter.') }}
        </div>
        ...
        <x-jet-dialog-modal wire:model="confirmingUserDeletion">
            ...
            <x-slot name="content">
                {{ __('Tem certeza de que deseja excluir sua conta? Depois que sua conta for excluída, todos os seus
                recursos e dados serão excluídos permanentemente. Digite sua senha para confirmar que deseja excluir
